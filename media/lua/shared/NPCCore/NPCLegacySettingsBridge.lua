...
NPCLegacySettingsBridge.Defaults = NPCLegacySettingsBridge.Defaults or {
    World_Enabled = true,
    World_InitialGroups = 42,
    World_MaxVirtualGroups = 110,
    World_MaxPhysicalGroups = 8,
    ...
    World_ActivationNPCSoftCapPerPlayer = 32,
    World_DeferredActivationRetryMinutes = 0.72,
    World_MaterializeBattlePairAsSingleWave = true,
    World_InitialRoadPatrolsGreen = 12,
    World_InitialRoadPatrolsRed = 12,
    World_MaxRoadPatrols = 40,
    World_SpawnChancePerTenMin = 34,
    World_PatrolEncounterPairs = 14,
    World_UrbanSpawnRadius = 220,
    World_RoadPatrolUrbanRadius = 260,
    World_PatrolTargetRadius = 240,
    World_RelocateRuralGroups = true,

    SpawnQueue_Enabled = true,
    SpawnQueue_MaxPerTick = 2,
    SpawnQueue_MaxEventsPerTick = 1,
    SpawnQueue_MaxPending = 180,
    ...
    AIWork_Enabled = true,
    AIWork_MaxHeavyOpsPerTick = 18,
    AIWork_CombatOpsPerTick = 24,
    AIWork_UtilityOpsPerTick = 18,
    AIWork_ZombieOpsPerTick = 28,
    AIWork_MarkerOpsPerTick = 48,
    AIWork_PhysicalOpsPerTick = 72,
    AIWork_PathOpsPerTick = 10,
    AIWork_ZombiePathOpsPerTick = 8,
    AIWork_SenseOpsPerTick = 24,
    AIWork_LOSOpsPerTick = 36,
    AIWork_AdaptiveBudget = true,
    AIWork_AdaptiveSampleTicks = 30,
    AIWork_LowFPS = 42,
    AIWork_CriticalFPS = 28,
    AIWork_HighNPC = 36,
    AIWork_CriticalNPC = 58,
    AIWork_HighZombies = 220,
    AIWork_CriticalZombies = 380,
    AIWork_HighBudgetPercent = 70,
    AIWork_CriticalBudgetPercent = 45,
    AIWork_HighIntervalMultiplier = 2,
    AIWork_CriticalIntervalMultiplier = 4,
    AIWork_MaxZombieInterval = 32,
    AIWork_DebugSummary = false,
    AIWork_DebugSummaryMs = 15000,
    AIWork_CombatThinkInterval = 2,
    AIWork_IdleThinkInterval = 8,
    AIWork_FarThinkInterval = 32,
    AIWork_ZombieCheckInterval = 4,
    AIWork_ZombieCacheBaseInterval = 4,
    AIWork_ZombieCacheHighInterval = 8,
    AIWork_ZombieCacheCriticalInterval = 12,
    ...
    LOD_PhysicalSpawnRadius = 190,
    LOD_PhysicalDespawnRadius = 420,
    LOD_PhysicalDespawnHighLoadRadius = 360,
    LOD_PhysicalDespawnCriticalRadius = 300,
    LOD_PhysicalDespawnImportantRadius = 650,
    LOD_PhysicalDespawnMinAgeSeconds = 30,
    LOD_PhysicalCleanupIntervalTicks = 1200,
    LOD_PhysicalCleanupHighIntervalTicks = 600,
    LOD_PhysicalCleanupCriticalIntervalTicks = 300,
    LOD_MaxPhysicalNPCPerPlayer = 36,
    LOD_MaxPhysicalNPCGlobal = 90,
    ...
    Net_MaxMarkerEventsPerTick = 18,
    Net_SnapshotChunkSize = 32,
    Net_GlobalMarkerUpdateSeconds = 21.6,
    Net_NearMarkerUpdateSeconds = 5.4,
    Net_DebugMapEnabled = true,
    Net_MaxMarkerRemovesPerTick = 24,
    Net_MaxPendingMarkerUpdates = 1200,
    Net_MaxPendingMarkerRemoves = 400,
    Net_MaxSnapshotChunksPerTick = 2,
    Net_MaxSnapshotMarkers = 5000,
    Net_MaxSimStateUpdatesPerTick = 18,
    Net_LifecycleStateUpdatesPerRun = 18,
    Net_LifecycleHeavyPayloadSeconds = 30,
    Net_QueuedSnapshotSync = true,
    Net_SyncCooldownSeconds = 5.0,
    ...
    Net_PlayerUpdateMinIntervalMs = 500,
    Net_StateUpdateMinIntervalMs = 180,
    Net_DebugMapRequestCooldownSeconds = 6.0,
    Net_DebugMapMaterializeCooldownMs = 1200,
    Net_OrderCommandMinIntervalMs = 250,
    ...
    Debug_DiagnosticsRateMs = 5000,
    Debug_MapMarkerAutoMaterialize = true,
    Debug_MapMarkerMaterializeCooldownMs = 2500,
    ...
    Runtime_TaskQueueHighBudget = 6,
    Runtime_TaskQueueNormalBudget = 12,
    Runtime_TaskQueueLowBudget = 18,
    Runtime_SettingsCacheSeconds = 5,
    Runtime_TablePoolMax = 64,

    StreamingRuntime_Enabled = true,
    StreamingRuntime_Debug = false,
    StreamingRuntime_SampleTicks = 30,
    StreamingRuntime_FastVehicleSpeed = 8.0,
    StreamingRuntime_TravelCooldownSeconds = 12,
    StreamingRuntime_DeferMaterialization = true,
    StreamingRuntime_DeferRetrySeconds = 10,
    StreamingRuntime_CriticalRetrySeconds = 18,
    StreamingRuntime_NPCHigh = 32,
    StreamingRuntime_NPCCritical = 56,
    StreamingRuntime_PendingSpawnHigh = 10,
    StreamingRuntime_PendingSpawnCritical = 24,
    StreamingRuntime_PendingMarkerHigh = 160,
    StreamingRuntime_PendingMarkerCritical = 420,
    StreamingRuntime_PendingTaskHigh = 80,
    StreamingRuntime_PendingTaskCritical = 180,
    StreamingRuntime_MediumThreshold = 38,
    StreamingRuntime_HighThreshold = 68,
    StreamingRuntime_CriticalThreshold = 102,
    StreamingRuntime_HeatDecay = 11,

    CrowdBudget_Enabled = true,
    CrowdBudget_Debug = false,
    CrowdBudget_SampleTicks = 45,
    CrowdBudget_NearRadius = 180,
    CrowdBudget_ZombieRadius = 140,
    CrowdBudget_MaxNPCNearPlayer = 42,
    CrowdBudget_CriticalNPCNearPlayer = 64,
    CrowdBudget_MaxZombiesNearPlayer = 220,
    CrowdBudget_CriticalZombiesNearPlayer = 360,
    CrowdBudget_RetrySeconds = 12,
    CrowdBudget_CriticalRetrySeconds = 24,
    CrowdBudget_DripFeedMaxBatch = 4,
    CrowdBudget_CriticalDripFeedMaxBatch = 2,
    CrowdBudget_UrbanTightenPercent = 20,
    CrowdBudget_FastTravelTightenPercent = 35,
    CrowdBudget_PreserveCombat = true,

    AILOD_Enabled = true,
    AILOD_NPCFullRadius = 42,
    AILOD_NPCHighRadius = 90,
    AILOD_NPCMediumRadius = 180,
    AILOD_NPCLowRadius = 320,
    AILOD_ProxyUpdateSeconds = 14,
    AILOD_UseCriticality = true,
    AILOD_DebugLog = false,
    AILOD_PhysicalFrameEnabled = true,
    AILOD_PhysicalFullInterval = 1,
    AILOD_PhysicalHighInterval = 2,
    AILOD_PhysicalMediumInterval = 4,
    AILOD_PhysicalLowInterval = 8,
    AILOD_PhysicalProxyInterval = 16,
    BrainScheduler_Enabled = true,
    BrainScheduler_MinThinkMs = 120,
    BrainScheduler_LowThinkMs = 900,
    BrainScheduler_ProxyThinkMs = 2400,
    BrainScheduler_DebugLog = false,
    Interest_Enabled = true,
    Interest_WorldMapRadius = 700,
    Interest_MinimapRadius = 180,
    Interest_SyncRadius = 900,
    ...
    Influence_MaxCells = 2200,
    Influence_UpdateBucketsPerTick = 18,
    ...
    World_RoadPatrolStepRadius = 90,
    World_RoadPatrolBattleRadius = 125,
    World_RoadPatrolBattleKeepRadius = 190,
    World_RoadPatrolBattleTickMinutes = 6.0,
    World_PreferredPointAttempts = 1900,
    World_FallbackPointAttempts = 360,
    World_VirtualTargetAttempts = 240,

    Director_Enabled = true,
    Director_DryRun = true,
    Director_DebugLog = false,
    Director_MaxEvents = 120,
    Director_WorldMemoryCellSize = 150,
    Director_MaxMemoryCells = 900,
    ...
    Base_MaxBases = 24,
    Base_Radius = 82,
    Base_MinDistance = 640,
    Base_SearchAttempts = 180,
    Base_CaptureHours = 0.75,
    Base_StatusWindowTimeoutSeconds = 8,
    Base_GroupTargetRadius = 2200,
    Base_HomeAssignRadius = 420,
    Base_ZoneRebalanceMinutes = 15,
...
function NPCLegacySettingsBridge.ApplyWorldDirector(director)
    ...
    director.VIRTUAL_MOVE_SPEED_TILES_PER_HOUR = NPCLegacySettingsBridge.GetNumber("World_VirtualMoveSpeedTilesPerHour", director.VIRTUAL_MOVE_SPEED_TILES_PER_HOUR, 1, 1000)
